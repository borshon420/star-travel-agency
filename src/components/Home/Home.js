          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Lisbon's name may have been derived from Proto-Celtic or
                  Celtic Olisippo, Lissoppo, or a similar name which other
                  visiting peoples like the ancient.
                </Card.Text>
                <Link to="/destination">
          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  First documented in 1147, Moscow grew to become a prosperous
                  and powerful city that served as the capital of the Grand
                  Duchy that bears its namesake.
                </Card.Text>
                <Link to="/destination">
                  <Button variant="dark">Visit Now</Button>
                </Link>
          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  The Real Club de Tenis Barcelona - 1899 (meaning Royal
                  Bercelona Tennis Club - 1899) is a private tennis club in
          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  motorboat has one or more engines that propel the vessel over
                  the top of the water. Boat engines vary in
                </Card.Text>
                <Link to="/promotion">
          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Most modern cushioned mattress on a bed frame, the mattress
                  resting either on a solid base, often
                </Card.Text>
                <Link to="/promotion">
                  <Button variant="dark">Get Promotion</Button>
                </Link>
          ...
          <div className="destination-card">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  scooter in the 1960s with the name "kangaroo scooter",
                  kangaroo scooters were built in Taiwan
                </Card.Text>
                <Link to="/promotion">
                  <Button variant="dark">Get Promotion</Button>
                </Link>
